const STEPS = [
  ...
  },
  {
    ...
    text:
      'Bestätige in der Steuerung, dass der Stern zentriert ist. ' +
  ...
  },
  {
    ...
    text:
      'Fahre einen zweiten Stern an, der möglichst weit vom ersten entfernt ' +
      'steht (anderer Sektor des Himmels). Zentriere und bestätige.',
  },
  {
    title: 'Optionales 3-Stern-Alignment',
    text:
      'Für bessere Genauigkeit: Einen dritten Stern in einem weiteren Sektor ' +
  ...
  },
  {
    ...
    text:
      'Fahre einen bekannten Stern an und prüfe, ob er im Okular erscheint. ' +
